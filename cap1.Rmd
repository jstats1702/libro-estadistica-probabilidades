...
De manera similar, el \textbf{promedio poblacional} de \( X \), denotado con \( \mu \), se define como:
\[
...
La taxonomía más conocida sobre las escalas de medición la presenta [@stevens1951], quien las clasifica en nominales, ordinales, de intervalos y de razón:
